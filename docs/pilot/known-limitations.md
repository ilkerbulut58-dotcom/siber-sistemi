...
- Benchmark profiles hidden from customer UI.
- Blind validation uses encrypted holdout; results are CI-only.
- German/EU legal privacy texts require legal review before production.
