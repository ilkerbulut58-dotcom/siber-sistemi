  ...
  return (
    <Card className="border-violet-500/30 bg-gradient-to-br from-violet-500/10 via-card/90 to-indigo-500/5 shadow-[0_0_32px_-8px_rgba(139,92,246,0.35)]">
      ...
      <CardContent className="space-y-4 text-sm">
        ...
        {priorities.length > 0 && (
          <div>
            <p className="mb-2 font-medium text-violet-200">{t("analytics.criticalPriorities")}</p>
        ...
        {firstSteps.length > 0 && (
          <div>
            <p className="mb-2 font-medium text-violet-200">{t("analytics.recommendedFixOrder")}</p>
